              ...
              <div className="border-t border-gray-200 pt-4">
                {loading ? (
                  ...
                  <div className="flex flex-col space-y-2">
                    <Link
                      href="/auth/login"
                      className="text-sm font-medium text-gray-700 hover:text-blue-600 px-2 py-1"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      카카오 로그인
                    </Link>
                    <Link
                      href="/auth/register"
                      className="text-sm font-medium bg-yellow-400 text-gray-900 px-4 py-2 rounded-md hover:bg-yellow-500 text-center"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      카카오로 시작하기
                    </Link>
